  ...
  res.json({
    ...
    paths: {
      ...
      '/api/employees/invite': {
        post: {
          summary: 'Invite new employee (Figma UI form)',
          tags: ['Employees'],
          security: [{ BearerAuth: [] }],
          requestBody: {
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    profilePhoto: { type: 'string', example: 'base64_image_data' }
                  }
                }
              }
            }
          ...
          responses: {
            '201': { description: 'Employee invitation sent successfully' },
      ...
      '/api/employees/roles': {
        get: {
          summary: 'Get roles for dropdown (Figma UI)',
          tags: ['Employees'],
          security: [{ BearerAuth: [] }],
          responses: {
            '200': { description: 'List of available roles' }
          }
        }
      },
      '/api/employees/departments': {
        get: {
          summary: 'Get departments for dropdown (Figma UI)',
          tags: ['Employees'],
          security: [{ BearerAuth: [] }],
          responses: {
            '200': { description: 'List of available departments' }
          }
        }
      },
      '/api/employees/working-models': {
        get: {
          summary: 'Get working models for dropdown (Figma UI)',
          tags: ['Employees'],
          security: [{ BearerAuth: [] }],
          responses: {
            '200': { description: 'List of available working models' }
          }
        }
      }
    }
