...
// Create a temporary deployment file without team restrictions
function createTempDeploymentFile() {
  const tempIndex = `const express = require('express');
...
module.exports = app;`;
  ...
  fs.writeFileSync(path.join(__dirname, 'index_put_fixed.js'), tempIndex);
  console.log('✅ Created temporary fixed deployment file: index_put_fixed.js');
}

createTempDeploymentFile();